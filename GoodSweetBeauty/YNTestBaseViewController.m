...
//    one.model = self.BusinessModel;
//    CenterTwoViewController *two = [CenterTwoViewController new];
//    two.model = self.BusinessModel;
//    //配置信息
...
//    [self.image_head sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",ADDRESS_IMG,[self.BusinessModel.profile.avatar stringByReplacingOccurrencesOfString:@"small" withString:@"middle"]]] placeholderImage:[UIImage imageNamed:@"head"]];
//    
...
//    [self.lab_username setText:self.BusinessModel.profile.username];
...
//    NSArray *dataarr = [NSArray arrayWithObjects:[NSString stringWithFormat:@"%ld",(long)self.BusinessModel.profile.my_follower_count],[NSString stringWithFormat:@"%ld",(long)self.BusinessModel.profile.my_fans_count],[NSString stringWithFormat:@"%ld",(long)self.BusinessModel.profile.my_posts_count], nil];
...
//    if (self.BusinessModel.profile.vip==0) {
//        
//        self.image_v.hidden =YES;
//    }else{
//        
//        hiddenview = NO;
//        self.image_v.whc_Size(11,9).whc_LeftSpace(7).whc_CenterY(0).whc_RightSpaceToView(5,self.image_level);
//        self.image_v.image = [UIImage imageNamed:@"iconVRed"];
//    }
//    if (self.BusinessModel.profile.level==0) {
//        
//        self.image_level.hidden =YES;
//        
//    }else{
//        
//        hiddenview =NO;
//        self.image_level.whc_Size(12,11).whc_RightSpace(7.5).whc_CenterY(0);
//        self.image_level.image = [UIImage imageNamed:[NSString stringWithFormat:@"iconLv%ld",(long)self.BusinessModel.profile.level]];
//    }
//    if (hiddenview) {
//       
//         self.view_v_level.whc_Width(0).whc_RightSpace(0).whc_Height(0).whc_CenterYToView(0,self.lab_username);
//    }else{
//    
